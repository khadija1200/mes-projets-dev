                            ...
                            <div class="share-box-inner">
                                ...
                                <div class="share-content-box w-100">
                                    <form class="share-text-box">
                                        <textarea name="share" class="share-text-field" aria-disabled="true" placeholder="Tu as envie de partager quelque chose !?" data-bs-toggle="modal" data-bs-target="#textbox" id="email"></textarea>
...
============================================ -->
    ...
    <script>
        function onViewAnywayButtonClick(postId) {
            var sensitiveContent = document.getElementById('sensitiveContent' + postId);
            var postThumb = document.getElementById('postThumb' + postId);
            
            if (sensitiveContent.style.display === 'block') {
        ...
        $.ajax({
            url: "formulaire_avertissement.php",
            type: "POST",
            success: function(response) {
                ...
                if (responseObject.success) {
                    // Incrémenter le nombre de notifications
