...
<body class="bg-transparent">
        ...
        <div class="signup-form-wrapper" style="margin-top:5%" >
            <h1 class="create-acc text-center">Supprimer ce poste</h1>
            <div class="signup-inner text-center">
                <h3 class="title">Motifs</h3>
                <form class="signup-inner--form" method="post" action="./formulaire_suppression.php">
                    <div class="row">
                        
                        <div class="col-12">
                            <input type="text" class="single-field" name="motifs" value="Nos moderateurs ont décidé de supprimmer vos poste">
    ...
    if (!empty($_POST['motifs'])) {
        ...
        if(isset($_POST['post_id']) && isset($_POST['id_utilisateur'])) {
            ...
            if (mysqli_query($conn, $sql_notification)) {
                ...
                $sql_update_post = "UPDATE poste SET visibilite = 0 WHERE id = $post_id";
